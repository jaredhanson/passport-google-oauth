 ...
 */
var ENDPOINT_OLD = 'https://www.googleapis.com/oauth2/v1/userinfo';
var ENDPOINT_NEW = 'https://www.googleapis.com/plus/v1/people/me';
var ENDPOINT_NEW_OPENID = 'https://www.googleapis.com/plus/v1/people/me/openIdConnect';
...
function Strategy(options, verify, endpoint) {
  options = options || {};
  ...
  this.endpoint = endpoint ? (endpoint.openid ? ENDPOINT_NEW_OPENID : ENDPOINT_NEW) : ENDPOINT_OLD;
}
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get(this.endpoint, accessToken, function (err, body, res) {
