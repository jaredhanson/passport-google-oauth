...
Strategy.prototype.authorizationParams = function(options) {
  ...
  if (options.state) {
    ...
    // To mitigate against cross-site request forgery (CSRF),
    // it is strongly recommended to include an anti-forgery token in the state, and confirm it in the response. 
